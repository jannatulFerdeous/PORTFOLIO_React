    ...
    <section className={'about'+ 'skills-container'} id='About'>
        ...
        <div className='about-container'>    
            <div className='about-data'>
                <div className='about-info'><h3>Personal Details</h3></div> 
                <div className='about-details-parents'>
                    <div className='about-details'>
                        <p>FirstName: <span>Jannatul</span></p>
                        <p>LastName: <span>Ferdeous</span></p>
                    ...
                    <div className='about-details'>
                        ...
                        <p>Address:<span> Kuril, Dhaka, Bangladesh</span></p>
                        <p>Phone: <span> +880 198 2108 165</span></p>
                        <p>Email: <span>jannatul.gub@gmail.com</span></p>
                        <p>Language:<span> Bengali, English, Hindi, Italy(few)</span></p> 
                    </div>
                </div> 
            </div>
